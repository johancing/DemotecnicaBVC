...
public class Invoice {
	...
	public void setNames(String names) throws BusinessException {
		if (isBlank(names))
			throw new BusinessException("Names is invalid.");
		this.names = names;
	}
	...
	public void setAmount(double amount) throws BusinessException {
		if (amount < 0)
			throw new BusinessException("Invalid amout.");
		this.amount = amount;
	}
	...
	public void setTimelyPaymentDate(Date timelyPaymentDate) throws BusinessException {
		if (timelyPaymentDate == null)
			throw new BusinessException("Invalid timely payment date.");
